      ...
      <form class="psxl" @submit.prevent="login">
        <div class="flex column middle">
          <div>
            ...
            <om-text v-model="email" type="text" placeholder="Digite o e-mail"></om-text>
          </div>
          <div>
            <label class="flex left t3xl" for="password">Senha</label>
            <om-text v-model="password" type="password" placeholder="Digite a senha"></om-text>
          </div>
...
import omText from "@/components/input/omText.vue";
